...
\begin{itemize}
    ...
    \item \textbf{Maintainability and Modularity:} Highly decoupled architecture adhering to SOLID principles with 23+ automated unit tests.
\end{itemize}
...
The project features a comprehensive pytest suite comprising 23 automated tests verifying preprocessing, detection, severity boundaries, MDI calculations, IoU metrics, and end-to-end pipeline execution with a 100\% pass rate.
